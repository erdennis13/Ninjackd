...
class HistoriesControllerTest < ActionController::TestCase
  ...
  test "should create history" do
    assert_difference('History.count') do
      post :create, history: { complete: @history.complete, exercise_id: @history.exercise_id, subscription_id: @history.subscription_id }
    end
  ...
  test "should update history" do
    patch :update, id: @history, history: { complete: @history.complete, exercise_id: @history.exercise_id, subscription_id: @history.subscription_id }
    assert_redirected_to history_path(assigns(:history))
  end
